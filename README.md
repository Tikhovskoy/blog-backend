...
- Вывод популярных и свежих постов
- Поддержка изображений и заглушек
- Подсчёт и отображение количества комментариев и лайков
- Возможность комментировать посты (демонстрационные данные)
- Карта на странице контактов
- Адаптивная вёрстка
- Навигация между страницами (главная, посты, контакты)
